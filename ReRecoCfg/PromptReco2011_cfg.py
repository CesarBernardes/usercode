...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:F2850A23-14D2-E011-B2A8-003048F024F6.root')
)
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('test_RAW2DIGI_RECO_DQM_ALCA.root'),
...
process.DQMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('test_RAW2DIGI_RECO_DQM_ALCA_inDQM.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.pathALCARECOHcalCalMinBias,process.endjob_step,process.RECOoutput_step,process.DQMoutput_step,process.ALCARECOStreamHcalCalMinBiasOutPath)
